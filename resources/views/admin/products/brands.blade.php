    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Brands</h3>
                <p class="text-subtitle text-muted">Manage product brands.</p>
            </div>
                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>Rolex</td>
                                    <td>The iconic luxury watch brand.</td>
                                    <td>
                                ...
                                <tr>
                                    <td>Omega</td>
                                    <td>The first watch on the moon.</td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-primary">Edit</a>
                                        <a href="#" class="btn btn-sm btn-danger">Delete</a>
                                    </td>
                                ...
                                <tr>
                                    <td>Apple</td>
                                    <td>The best smartwatch for iPhone users.</td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-primary">Edit</a>
                                        <a href="#" class="btn btn-sm btn-danger">Delete</a>
                                    </td>
                                ...
                                <tr>
                                    <td>Casio</td>
                                    <td>The toughest watch in the world.</td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-primary">Edit</a>
                                        <a href="#" class="btn btn-sm btn-danger">Delete</a>
                                    </td>
